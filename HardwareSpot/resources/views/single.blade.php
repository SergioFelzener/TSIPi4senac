                    ...
                    <div class="container px-5 py-24 mx-auto">
                        <div class="lg:w-4/5 mx-auto flex flex-wrap">
                            ...
                            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                ...
                                <div class="flex mb-4">
                                    <span class="flex items-center"><!--estrelinhas-->
                                    ...
                                    <span class="flex ml-3 pl-3 py-2 border-l-2 border-gray-200">
                                        <a href="#" class="text-gray-500"><!-- SVG de redes sociais-->
                                ...
                                <div class="flex">
                                    ...
                                    <a class="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">Comprar</a>
