...
<head>
    ...
    <style>
        ...
        *,
        ...
        .shadow {
            box-shadow: 0 1px 4px 0 rgba(0, 0, 0, .1), 0 11px 13px 0 rgba(29, 41, 81, .50)
        }
                ...
                <div class="overflow-hidden rounded-lg shadow">
                    ...
                    <header class="bg-purple-100 border-t-4 border-l-0 border-r-0 border-b-0 border-purple-500  mt-2 border flex items-center justify-between leading-tight p-2 md:p-4">
                        ...
                        <p class="text-grey-darker text-sm">
                            ...
                            <span name="categories[]" class="block text-gray-500 tx-sm" value="">{{$category->name}}</span>
                            @endforeach
                        </p>
                    </header>
